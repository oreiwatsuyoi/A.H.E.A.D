...
import { patientService, appointmentService, encounterService } from '../services/api';
import PharmacyWidget from '../components/UI/PharmacyWidget';
                ...
                <div className="space-y-4">
                  {recentEncounters.map((encounter) => (
                    <div key={encounter.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                      <div className="flex items-center">
                        <div className="bg-health-100 p-2 rounded-lg mr-4">
